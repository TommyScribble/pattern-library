		...
		<PageLayout>
			...
			<Accordion multitabs={false}>
				<AccordionItem title={'Are alligators active at night?'}>
					...
					times when alligators are most active. They typically feed at dusk and
					through the night, and may still be active at dawn.
				</AccordionItem>
				<AccordionItem title={'Can alligators survive freezing weather?'}>
					When it gets cold in the winter, alligators slow down. ... Alligators
					can even survive freezing conditions. They have been known to rise to
					the surface if the water is about to freeze, with their nostrils above
					the surface. This allows them to breathe through the ice as it forms.
				</AccordionItem>
